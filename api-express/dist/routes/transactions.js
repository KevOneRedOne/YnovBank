 ...
 */
router.post('/deposit', auth_1.default, transactionController_1.default.deposit);
/**
 * @swagger
 ...
 *         description: Non autorisé
 */
router.post('/withdrawal', auth_1.default, transactionController_1.default.withdrawal);
/**
 * @swagger
 ...
 *         description: Non autorisé
 */
router.post('/transfer', auth_1.default, transactionController_1.default.transfer);
/**
 * @swagger
 * /api/transactions:
 *   get:
 ...
 *         description: Non autorisé
 */
router.get('/', auth_1.default, transactionController_1.default.getUserTransactions);
/**
 * @swagger
 ...
 *         description: Non autorisé
 */
router.get('/account/:accountId', auth_1.default, transactionController_1.default.getAccountTransactions);
/**
 * @swagger
 * /api/transactions/{id}:
 *   get:
 ...
 *         description: Non autorisé
 */
router.get('/:id', auth_1.default, transactionController_1.default.getTransactionById);
/**
 * @swagger
 ...
 *         description: Non autorisé
 */
router.patch('/:id/cancel', auth_1.default, transactionController_1.default.cancelTransaction);
